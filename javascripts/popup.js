var METABAR_adsPopup = new function() {
    this.settings = {
        "toolbar_id": 297317,
        "partner": "ovkuse",
        "host": "metabar.ru",
        "html": '<!-- IE --><div class="popup">     <div class="popup-cnt">         <a href="#" onclick="window.parent.METABAR_adsPopup.removeAdsPopup(true); return false;" class="popup-close" title="Закрыть">Закрыть</a>         <div class="popup-logo">             <img src="http://design.metabar.ru/i/partners/ovkuse/popup/logo.png" alt="">         </div>         <h1 class="popup-title">Добавь Ovkuse в&nbsp;свой браузер и&nbsp;узнавай новости первым!<br>Установи бесплатно.</h1>         <div class="popup-toolbar">             <img src="http://design.metabar.ru/i/partners/ovkuse/popup/toolbar.png" alt="">         </div>         <div class="popup-submit">             <a href="" id="installButton" class="btn">Установить приложение</a><br>             <a id="landingButton" href="http://ovkuse.metabar.ru" target="_blank">Узнать подробнее</a>         </div>     </div> </div> <!-- END_IE --> <!-- FF --><div class="popup">     <div class="popup-cnt">         <a href="#" onclick="window.parent.METABAR_adsPopup.removeAdsPopup(true); return false;" class="popup-close" title="Закрыть">Закрыть</a>         <div class="popup-logo">             <img src="http://design.metabar.ru/i/partners/ovkuse/popup/logo.png" alt="">         </div>         <h1 class="popup-title">Добавь Ovkuse в&nbsp;свой браузер и&nbsp;узнавай новости первым!<br>Установи бесплатно.</h1>         <div class="popup-toolbar">             <img src="http://design.metabar.ru/i/partners/ovkuse/popup/toolbar.png" alt="">         </div>         <div class="popup-submit">             <a href="" id="installButton" class="btn">Установить приложение</a><br>             <a id="landingButton" href="http://ovkuse.metabar.ru" target="_blank">Узнать подробнее</a>         </div>     </div> </div><!-- END_FF --><!-- CHROME --><div class="chrome-popup"> <div class="popup-cnt"><a href="#" onclick="window.parent.METABAR_adsPopup.removeAdsPopup(true); return false;" class="chrome-popup-close" title="Закрыть">Закрыть</a>  <div class="chrome-popup-logo"><img src="http://design.metabar.ru/i/partners/ovkuse/popup/logo2.png" alt=""> </div> <h1 class="chrome-popup-title">Добавь Ovkuse в&nbsp;свой браузер и&nbsp;узнавай новости первым!<br>Установи бесплатную программу.</h1> <div class="chrome-popup-toolbar">  <img src="http://design.metabar.ru/i/partners/ovkuse/popup/toolbar.jpg" alt="">  </div> <div class="chrome-popup-submit"> <a href="" id="installButton" class="chrome-btn">Установить приложение</a><br> <a id="landingButton" href="http://ovkuse.metabar.ru">Узнать подробнее</a> </div> </div> </div><!-- END_CHROME -->',
        "css": '<!-- IE -->* {margin:0; padding:0; outline:0;}         /* Popup */   .popup, .popup-cnt, .btn {         position:relative;  *zoom:1;         behavior:url(http://metabar.ru/static/css/PIE.htc);      }     .popup a {color:#65971b;}     .popup {        width:630px; height:397px; z-index:100;        background:#bebebe; padding:11px; text-align:center; font:12px/18px Tahoma,Arial,sans-serif; color:#000;        -webkit-border-radius:14px;         -khtml-border-radius:14px;         -moz-border-radius:14px;         -o-border-radius:14px;         border-radius:14px;     }    .popup-cnt, .btn {      background:#fff; padding:27px 50px;         -webkit-border-radius:3px;         -khtml-border-radius:3px;         -moz-border-radius:3px;         -o-border-radius:3px;         border-radius:3px;     }     .popup-close {position:absolute; top:0; right:0; width:34px; height:34px; overflow:hidden; display:block; background:url(http://design.metabar.ru/i/partners/ovkuse/popup/icon-close.png) 50% no-repeat; text-indent:-9999em;}     .popup-logo {margin-bottom:9px;}     .popup-title {font-weight:normal; font-size:12px; margin-bottom:16px;}     .popup-toolbar {margin-bottom:36px;}     .popup-submit {font-size:11px; margin-bottom:8px;}          .btn {         display:-moz-inline-stack; display:inline-block; *display:inline; vertical-align:top; text-decoration:none; padding:0 29px; margin-bottom:5px;         color:#fff !important; font:15px/38px \'Trebuchet MS\',Arial,sans-serif; text-shadow: 0 1px rgba(27,129,181,.35);         -moz-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);       -khtml-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);         -webkit-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);        -o-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);         box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);         background:#6ba420; /* Old browsers */         background-image:-webkit-gradient(linear, left top, left bottom, from(#77b43b), to(#6ba420)); /* Saf4+, Chrome */         background-image:-webkit-linear-gradient(top, #77b43b, #6ba420); /* Chrome 10+, Saf5.1+, iOS 5+ */         background-image: -moz-linear-gradient(top, #77b43b, #6ba420); /* FF3.6 */         background-image:  -ms-linear-gradient(top, #77b43b, #6ba420); /* IE10 */         background-image:   -o-linear-gradient(top, #77b43b, #6ba420); /* Opera 11.10+ */         background-image:      linear-gradient(to bottom, #77b43b, #6ba420);         -pie-background: linear-gradient(top, #77b43b, #6ba420);     } .ie8, .ie7 {position: relative !important}<!-- END_IE --> <!-- FF -->* {margin:0; padding:0; outline:0;}         /* Popup */   .popup, .popup-cnt, .btn {         position:relative;  *zoom:1;         behavior:url(http://metabar.ru/static/css/PIE.htc);      }     .popup a {color:#65971b;}     .popup {        width:630px; height:397px; z-index:100;        background:#bebebe; padding:11px; text-align:center; font:12px/18px Tahoma,Arial,sans-serif; color:#000;        -webkit-border-radius:14px;         -khtml-border-radius:14px;         -moz-border-radius:14px;         -o-border-radius:14px;         border-radius:14px;     }    .popup-cnt, .btn {      background:#fff; padding:27px 50px;         -webkit-border-radius:3px;         -khtml-border-radius:3px;         -moz-border-radius:3px;         -o-border-radius:3px;         border-radius:3px;     }     .popup-close {position:absolute; top:0; right:0; width:34px; height:34px; overflow:hidden; display:block; background:url(http://design.metabar.ru/i/partners/ovkuse/popup/icon-close.png) 50% no-repeat; text-indent:-9999em;}     .popup-logo {margin-bottom:9px;}     .popup-title {font-weight:normal; font-size:12px; margin-bottom:16px;}     .popup-toolbar {margin-bottom:36px;}     .popup-submit {font-size:11px; margin-bottom:8px;}          .btn {         display:-moz-inline-stack; display:inline-block; *display:inline; vertical-align:top; text-decoration:none; padding:0 29px; margin-bottom:5px;         color:#fff !important; font:15px/38px \'Trebuchet MS\',Arial,sans-serif; text-shadow: 0 1px rgba(27,129,181,.35);         -moz-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);       -khtml-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);         -webkit-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);        -o-box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);         box-shadow:inset 0 0 0 2px rgba(255,255,255,.2);         background:#6ba420; /* Old browsers */         background-image:-webkit-gradient(linear, left top, left bottom, from(#77b43b), to(#6ba420)); /* Saf4+, Chrome */         background-image:-webkit-linear-gradient(top, #77b43b, #6ba420); /* Chrome 10+, Saf5.1+, iOS 5+ */         background-image: -moz-linear-gradient(top, #77b43b, #6ba420); /* FF3.6 */         background-image:  -ms-linear-gradient(top, #77b43b, #6ba420); /* IE10 */         background-image:   -o-linear-gradient(top, #77b43b, #6ba420); /* Opera 11.10+ */         background-image:      linear-gradient(to bottom, #77b43b, #6ba420);         -pie-background: linear-gradient(top, #77b43b, #6ba420);     } .ie8, .ie7 {position: relative !important}<!-- END_FF >  <!-- CHROME --> .chrome-btn { display:inline-block; vertical-align:top; text-decoration:none; padding:0 29px; margin-bottom:5px;color:#fff !important; font:15px/38px \'Trebuchet MS\',Arial,sans-serif; text-shadow: 0 1px rgba(27,129,181,.35);-webkit-box-shadow:inset 0 1px #fff; box-shadow:inset 0 1px #fff; background:#6ba420; /* Old browsers */ background-image:-webkit-gradient(linear, left top, left bottom, from(#77b43b), to(#6ba420)); /* Saf4+, Chrome */ background-image:-webkit-linear-gradient(top, #77b43b, #6ba420); /* Chrome 10+, Saf5.1+, iOS 5+ */ background-image:  linear-gradient(to bottom, #77b43b, #6ba420);} .chrome-popup-close {position:absolute; top:9px; right:9px; width:19px; height:17px; overflow:hidden; display:block; background:url(http://design.metabar.ru/i/partners/ovkuse/popup/icon-close2.png) 50% no-repeat; text-indent:-9999em;} .chrome-popup-logo {margin:27px 0 9px;} .chrome-popup-title {font-weight:normal; font-size:12px; margin-bottom:8px;} .chrome-popup-toolbar {margin:0 -85px -74px 0;} .chrome-popup-submit {font-size:11px; margin-bottom:8px;} .chrome-popup a {color:#65971b;} .chrome-popup {  width:652px; height:420px; position:fixed; top:50%; left:50%; margin:-210px 0 0 -326px; z-index:100;  background:#fff; text-align:center; font:12px/18px Tahoma,Arial,sans-serif; color:#000; -webkit-box-shadow:inset 0 1px #fff;  box-shadow:inset 0 1px #fff;  background-image: -webkit-linear-gradient(top, #d2d3d4, #fefdfd 8%, #fffefe 9%, #fffefe);  background-image:   linear-gradient(to bottom, #d4d6d6, #fefdfd 8%, #fffefe 9%, #fffefe);} .chrome-popup,.chrome-btn {-webkit-border-radius:3px; border-radius:3px; <!-- END_CHROME -->',
        "opera_allowed": false,
        "chrome_allowed": true,
        "fixed_position": true,
        "pagesBeforeShow": 2,
        ...
        'overlay': true,
        'overlayFixed': true,
        'overlayCss': 'background:#fff; opacity:0.8; display:block; position:fixed; top:0; bottom:0; left:0; right:0; z-index:50; -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)"; filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=40);',
        'width': 652,
        'height': 419
    };
    ...
    this.setAnotherToolbarAdsPopup = function(toolbar_id) {
        if (this.iframeDocument) {
            if (this.anotherToolbarHtml) {
                var el = this.iframeDocument.getElementById('popup');
                el.innerHTML = this.anotherToolbarHtml;
            }
            this.userToolbarId = toolbar_id;
        }
    };


    this.removeAdsPopup = function(track, daysHide) {
        daysHide = daysHide || this.settings.daysHide || 90;
        if (!this.iframe) {
            return;
        }
        if (track && this.iframeDocument) {
            // this.iframeDocument.write("<img style='display:block; position:absolute;' src='" + 'http://' + this.settings.host + "/stats/add_adsPopup_close_stat/?toolbar_id=" + this.settings.toolbar_id + "' />");
        }
        var expires = new Date();
        expires.setDate(expires.getDate() + daysHide);
        this.setCookie('hide_metabar_adsPopup', 'true', expires.toGMTString(), '/', null, null);
    ...
    this.installToolbar = function() {
        var url = 'http://' + this.settings.host + '/toolbar/download/' + this.settings.toolbar_id + '/?rnd=' + (parseInt(Math.random() * Math.pow(10, 16))) + '&download=1';

        if (this.userToolbarId && (this.IS_IE || this.IS_FF)) {
            var url = "http://" + this.settings.host + "/account/edit_toolbar/" +
                this.userToolbarId +
                "/?from_toolbar=1&combined_toolbar_id=" +
                this.settings.toolbar_id;
        }

        //this.iframeDocument.write("<img style='display:block; position:absolute;' src='" + 'http://' + this.settings.host + "/stats/add_adsPopup_install_stat/?toolbar_id=" + this.settings.toolbar_id + "' />");
        window._gaq = window._gaq || [];
        window._gaq.push(['mbr._trackPageview', '/adspopup/' + this.settings.partner + '/install_click']);

        this.removeAdsPopup(false);
    ...
    this.goToLanding = function() {
        window._gaq = window._gaq || [];
        window._gaq.push(['mbr._trackPageview', '/adspopup/' + this.settings.partner + '/landing_click']);

        var url = "http://" + this.settings.partner + "." + this.settings.host;
        this.removeAdsPopup(false);
        window.open(url);
        return false;
    };
    ...
    this.inject = function() {
        try {
             if (this.settings.pagesBeforeShow && this.settings.pagesBeforeShow > this.getCookie("mbr-pages-cnt")) {
             var expires = new Date();
             expires.setDate(expires.getDate() + 1);
             expires.setHours(0);
             expires.setMinutes(0);
             var countPages = this.getCookie("mbr-pages-cnt") || 0;
             countPages++;
             this.setCookie('mbr-pages-cnt', countPages, expires.toGMTString(), '/', null, null);
             return;
            ...
            if ((this.IS_WIN || this.IS_FF) && (this.IS_IE || this.IS_FF || (this.IS_OPERA && this.settings.opera_allowed) || (this.IS_CHROME && this.settings.chrome_allowed)) && !this.getCookie('hide_metabar_adsPopup')
                && !popupRE.test(window.name) && (window.parent == window)) {

                if (this.settings.overlay) {
                    this.overlay = document.createElement("div");
                    this.overlay.id = "overlayAdsPopup";
                    this.overlay.style.cssText = this.settings.overlayCss;

                    if (!this.settings.overlayFixed) {
                        this.overlay.onclick = function() {
                            this.removeAdsPopup(true, this.settings.daysHide);
                        };
                    }
                ...
                this.iframe.style.top = Math.round((docElem.clientHeight - this.settings.height) / 2) + "px";
                this.iframe.style.left = Math.round((docElem.clientWidth - this.settings.width) / 2) + "px";
                this.iframe.style.overflow = "hidden";
                this.iframe.style.zIndex = "1000000";
                this.iframe.style.border = "0px";
                this.iframe.style.backgroundColor = "transparent";
                this.iframe.style.boxShadow = "0 25px 65px #000"
                ...
                this.iframe.setAttribute("width", this.settings.width + "px");
                ...
                var headcrabHTML = "";
                var css = "";
                if (this.IS_IE && /<!-- IE -->(.*)<!-- END_IE -->/.test(this.settings.html)) {
                ...
                if (this.IS_IE && /<!-- IE -->(.*)<!-- END_IE -->/.test(this.settings.css)) {
                    css = /<!-- IE -->(.*)<!-- END_IE -->/.exec(this.settings.css)[1];
                }
                else if (this.IS_FF && /<!-- FF -->(.*)<!-- END_FF -->/.test(this.settings.css)) {
                    css = /<!-- FF -->(.*)<!-- END_FF -->/.exec(this.settings.css)[1];
                }
                else if (this.IS_OPERA && /<!-- OPERA -->(.*)<!-- END_OPERA -->/.test(this.settings.css)) {
                    css = /<!-- OPERA -->(.*)<!-- END_OPERA -->/.exec(this.settings.css)[1];
                }
                else if (this.IS_CHROME && /<!-- CHROME -->(.*)<!-- END_CHROME -->/.test(this.settings.css)) {
                    css = /<!-- CHROME -->(.*)<!-- END_CHROME -->/.exec(this.settings.css)[1];
                }
                else {
                    css = this.settings.html;
                }
                ...
                try {
                    window._gaq = window._gaq || [];
                    window._gaq.push(['mbr._setAccount', 'UA-16723928-1']);
                    window._gaq.push(['mbr._trackPageview', '/adspopup/' + this.settings.partner + '/popup_view']);
                } catch (err) {
                }

                this.iframeDocument.write(headcrabHTML + stats_img + "<style>" + css + "</style>");
                this.iframeDocument.body.className += " " + body_class;

                this.iframeDocument.getElementById("installButton").onclick = function() {
                    self.installToolbar();
                    return false;
                };

                this.iframeDocument.getElementById("landingButton").onclick = function() {
                    self.goToLanding();
                    return false;
                };
                ...
                if (this.IS_IE) {
                    this.addPIE();
                    var divs = this.iframeDocument.getElementsByTagName("div");
                    if (window.PIE) {
                        for (var i=0; i < divs.length; i++) {
                            PIE.attach(divs[i]);
                        }
                        PIE.attach(this.iframeDocument.getElementById("installButton"));
                    }

                }

                this.iframeDocument.body.style.background = "none";
                ...
                this.addEventListener(window, "resize", function() {
                    if (self.iframe) {
                        ...
                        resizeTimeout = setTimeout(function() {
                            self.iframe.style.top = Math.round((docElem.clientHeight - self.settings.height) / 2) + "px";
                            self.iframe.style.left = Math.round((docElem.clientWidth - self.settings.width) / 2) + "px";
                        }, 300);
                    }
                });
            }
    ...
    this.addEventListener = function(elem, type, eventHandle) {
    ...
    this.set_metabar_installed = function(toolbar_id, version, source_id) {
        if (toolbar_id == this.settings.toolbar_id || source_id == this.settings.toolbar_id) {
            ...
            this.setAnotherToolbarAdsPopup(toolbar_id);
        }
    };
